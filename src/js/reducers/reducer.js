...
export const getAllTasks = () => dispatch => {
  axios.get(`https://api.cosmicjs.com/v1/todo-app/object-type/tasks`)
    .then((response) => {
...
export const postNewTask = (task) => dispatch => {
  ...
  axios.post(`https://api.cosmicjs.com/v1/todo-app/add-object`, {type_slug: "tasks", title: task, content: "New Task",
    metafields: [
      {
        title: "Is Complete",
        key: "is_complete",
...
export const putChangeStatus = (task, bool) => (dispatch) => {
  ...
  axios.put(`https://api.cosmicjs.com/v1/todo-app/edit-object`, {slug: task.slug,
    metafields: [
      {
        title: "Is Complete",
        key: "is_complete",
...
export const deleteTask = (slug) => (dispatch) => {
  ...
  axios.delete(`https://api.cosmicjs.com/v1/todo-app/${slug}`)
    .then((response) => {
    console.log(response.data)
    })
    .catch((err) => {
